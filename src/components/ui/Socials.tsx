...
const Socials = () => {
  return (
    <div className="group flex h-auto w-full border-t-1 border-b-1 items-center text-accent border-accent hover:border-neutral-100 rounded-md transition duration-300">
      <a
